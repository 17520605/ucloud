...
class ServerController extends AdminBaseController
{
    ...
    public function serverManage() {
        ...
        // load template
        return $this->render('admin/server_manage.html', array(
    ...
    public function ajaxServerManageAddForm() {
        ...
        $cdn_url = '';
        $geo_upload_countries = array();
        $account_upload_types = array();
    ...
    public function serverManageTestFlysystem() {
        ...
        // load template
        return $this->render('admin/server_manage_test_server.html', array(
