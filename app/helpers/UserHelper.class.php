...
class UserHelper
{
    ...
    static function create($username, $password, $email = null, $title = null, $firstname = null, $lastname = null, $levelId = null) {
        ...
        $status = 'active';
        if(SITE_CONFIG_ADMIN_APPROVE_REGISTRATIONS === 'yes' && $levelId > 0) {
            $status = 'awaiting approval';
        }
        
        // figure out default privacy level
        $isPublic = 0;
        if(SITE_CONFIG_NEW_ACCOUNT_DEFAULT_FILE_PRIVACY === 'Public' || $levelId === 0) {
            $isPublic = 1;
        }
    ...
    static function loginRequiredToUpload() {
        return SITE_CONFIG_UPLOAD_LOGIN_REQUIRED === 'yes';
    }
}
